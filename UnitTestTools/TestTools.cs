...
namespace UnitTestTools
{
    ...
    public class TestTools
    {
        ...
        private static string _current_test;

        public static bool GitAvail
        {
            get {
                try
                {
        ...
        public static string RunCommand(string cmd, string args, bool print=false)
        {
            try
            {
        ...
        private static bool CommitLogFile()
        {
            ...
            {
                Console.WriteLine("Commit logfile failed with error: {0}", e);
            }
            return success;
        }
        ...
        public static void EndTest()
        {
            ...
            if (!found)
            {
                LogLine("Test " + _current_test + " not found!");
            }
        }
